...
<template>
  <Card
    class="overflow-hidden cursor-pointer flex flex-col"
    :pt="{
      root: { class: 'flex flex-col h-full' },
      body: { class: 'py-3! px-4! flex flex-col flex-1' },
      content: { class: 'flex flex-col flex-1 p-0!' },
  ...
  >
    ...
    <template #content>
      <div class="flex flex-col justify-between h-full">
        <div class="flex flex-wrap items-center gap-1.5 mb-2 capitalize">
          <Chip
            v-if="component"
            :label="component"
            icon="pi pi-box"
